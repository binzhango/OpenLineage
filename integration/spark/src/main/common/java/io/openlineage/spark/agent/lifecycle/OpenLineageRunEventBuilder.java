...
import static io.openlineage.client.Utils.convertValue;
...
class OpenLineageRunEventBuilder {
  ...
  private RunEvent populateRun(
    ...
    OpenLineage.JobFacets jobFacets =
        buildFacets(nodes, jobFacetBuilders, OpenLineage.JobFacets.class);
    ...
    RunFacets runFacets = buildFacets(nodes, runFacetBuilders, OpenLineage.RunFacets.class);
